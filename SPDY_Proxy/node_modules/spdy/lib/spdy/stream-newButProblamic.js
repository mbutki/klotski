...
function Stream(connection, options) {
  ...
  //console.log('STREAM HEADERS' + JSON.stringify(state.headers, null, "  "));
  //console.log('state.isPush:' + state.isPush);
  //console.log('state.headers[content-encoding]:' + state.headers['content-encoding']);
