...
//
exports.push = function push(host, path, url, headers, priority, callback) {
  ...
  var scheme = socket._spdyState.scheme;
  ...
  //host = headers.mike_host || socket._spdyState.host || 'localhost',
  //fullUrl = /^\//.test(url) ? scheme + '://' + host + url : url;
  //fullUrl = /^\//.test(url) ? scheme + '://' + headers.mike_host + url : url;
  ...
  //url = '/quant.js';
  //url =  '/SoftLayer4/js/jquery.min.js';
  //host = 'edge.quantserve.com';
  //host =  'www.softlayer.com';
  //fullUrl = 'http://edge.quantserve.com/quant.js';
  //fullUrl =  'http://www.softlayer.com/SoftLayer4/js/jquery.min.js';
  //host = 'www.softlayer.com'
  //url = '/metrika/watch.js'
  //host = 'www.narod.ru'
  //console.log('url:' + url);
